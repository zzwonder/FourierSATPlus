CC     = g++
OPT = -O2 -g
CFLAGS = -static -I cudd/cudd -I cudd/util -I cudd/ -I $(HPP_DIR) $(CUDD_INCLUSIONS) $(DLIB_INCLUSIONS) -std=c++11 $(OPT) -fopenmp

#LFLAGS = -L cudd/cudd/.libs/ -lcudd -lm
LFLAGS = cudd/cudd/.libs/libcudd.a -lm -lpthread -lX11 -std=c++11 -fopenmp
CUDD_DIR = cudd
